...
export const ActionTypes = {
  ...
  POLL: {
    ...
    DELETE_POLLS_START: `${ActionPrefixes.poll}/DELETE_POLLS_START`,
    DELETE_POLLS_SUCCESS: `${ActionPrefixes.poll}/DELETE_POLLS_SUCCESS`,
    DELETE_POLLS_FAIL: `${ActionPrefixes.poll}/DELETE_POLLS_FAIL`,
    ...
    EDIT_POLL_QUESTIONS_START: `${ActionPrefixes.poll}/EDIT_POLL_QUESTIONS_START`,
    EDIT_POLL_QUESTIONS_SUCCESS: `${ActionPrefixes.poll}/EDIT_POLL_QUESTIONS_SUCCESS`,
    EDIT_POLL_QUESTIONS_FAIL: `${ActionPrefixes.poll}/EDIT_POLL_QUESTIONS_FAIL`
  }
}
